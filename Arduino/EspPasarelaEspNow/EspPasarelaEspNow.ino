...
void setup() {
  ...
  esp_now_register_recv_cb([](uint8_t *mac, uint8_t *data, uint8_t len) {
    ...
    digitalWrite(LEDCheck, HIGH);
  	...
  	//Si el tamaño del mensaje es mayor que 20, es un mensaje con información del sensor, no enviamos con el inicio de $$, si es el mensaje de que está vivo, lo enviamos con %% para diferenciarlos.
  	if(len > 20){ Serial.write("$$"); }
  	else{ Serial.write("%%"); }
